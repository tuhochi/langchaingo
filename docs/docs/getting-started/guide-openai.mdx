...
```shell
go run github.com/tuhochi/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [ollama-chat-example](https://github.com/tuhochi/langchaingo/blob/main/examples/ollama-chat-example/ollama_chat_example.go)).
